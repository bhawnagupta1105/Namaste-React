...
const Header = () => {
  ...
  return (
    <div className="flex justify-between bg-white shadow-[0_15px_40px_-20px_rgba(40,44,63,0.15)]  fixed top-0 left-0 w-full z-[1000] h-[80px]">
        ...
        <ul className="flex flex-1 justify-end items-center h-full text-sm">
              ...
              <span className="mr-2.5">
                <svg
                  className={`fill-[#3d4152] ${
                    searchMatch && "fill-[#fc8019]"
                  } group-hover:fill-[#fc8019]`}
                  viewBox="5 -1 12 25"
                  height="17"
                  width="17"
                  fill="#686b78"
          ...
          <li className={`mr-[60px] font-semibold hover:text-[#fc8019] group`}>
            <Link className="flex" to="">
              <span className="mr-2.5">
                <svg
                  className="fill-[#3d4152] group-hover:fill-[#fc8019]"
                  viewBox="6 0 12 24"
                  height="19"
                  width="18"
                  fill="#686b78"
              ...
              <span className="mr-2.5 flex relative">
                <svg
                  className={`fill-[#60b246] group-hover:fill-[#fc8019] ${
                    checkoutMatch && "fill-[#fc8019] stroke-[#fc8019]"
                  } group-hover:stroke-[#fc8019] stroke-[#60b246]`}
                  viewBox="-1 0 37 32"
                  height="20"
                  width="22"
                  fill="#686b78"
